...
import { capitalizeFirstLetter, checkForFalsyValues, convertNumberToWords, formatNumberToIndianSystem, formatNumberToIndianSystemArea, numberToOrdinals } from "@Src/utils/globalUtilities";
...
const InvoiceSheetsData = ({ invoiceDataForMilestone, }: { invoiceDataForMilestone: any; }) => {
    ...
    return (
        <>
            <Document>
                <Page debug={false} size="A4" style={styles.page}>
                    {/* Content Container */}
...
export default InvoiceSheetsData;
