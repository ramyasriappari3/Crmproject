...
const AdminInvoice = (props: { showModal: any, setShowModal: any, unitId: any, custUnitId: any, paymentMilestoneId: any }) => {
    ...
    const formattedAddress = [
        invoiceDataForMilestone?.customer_flat_house_number,
        invoiceDataForMilestone?.address_street1,
        invoiceDataForMilestone?.address_street2,
        invoiceDataForMilestone?.address_state,
        invoiceDataForMilestone?.address_city,
        invoiceDataForMilestone?.address_country,
    ].filter(Boolean).join(', ');
